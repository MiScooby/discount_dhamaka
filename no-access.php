			...
			<div class="page-content d-flex align-items-center justify-content-center">
				...
				<div class="row w-100 mx-0 auth-page mt-5">
					<div class="col-md-8 col-xl-6 mx-auto d-flex flex-column align-items-center">
						...
						<h1 class="fw-bolder mb-22 mt-2 tx-80 text-muted">OOPS !!</h1>
						<h4 class="mb-2">Response Denied</h4>
						<h6 class="text-muted mb-3 text-center">Opps!! The page you were looking for doesn't exist.</h6>
