...
$planItems = $getInovceDataR['plan_deal_items'];
$planName = $getInovceDataR['plan_name'];

$planAmout = $getInovceDataR['plan_amnt'];
$tax = 18;
$gst = ($planAmout * $tax) / 100;
$netAmount = ($planAmout - $gst);
...
$pdf->MultiCell(55, 5,  $address, 0, 'R', 0, 1, 135, 25, true);
$pdf->MultiCell(55, 5, $email, 0, 'R', 0, 1, 135, 15, true);
...
$pdf->MultiCell(75, 5,  $invoiceName, 0, 'R', 0, 1, 114, 53, true);
$pdf->SetTextColor(134, 134, 134);
$pdf->SetFont($fontname, '', 10);
...
$pdf->SetLineStyle(array('width' => 0.1, 'color' => array(134, 134, 134)));
 ...
 <table cellspacing="1" cellpadding="9">
     ...
     <tr style="border: 1px solid #dadada; ">
         <td colspan="1">04</td>
         <td colspan="8"> $planType Vendor $planName Last Minute Deal Plan ($planItems items)
       </td>
     ...
     <td colspan="6"></td>
 <td colspan="3" style="border: 1px solid grey;"><span >NET AMOUNT</span></td>
 <td colspan="3" style="border: 1px solid grey;">&#8377;$netAmount</td>
 </tr>
 ...
 <tr style="font-size:12px; padding: 20px;">
 <td colspan="6"></td>
 <td colspan="3" style="border: 1px solid grey;"><span >TAX (18% gst)</span></td>
 <td colspan="3" style="border: 1px solid grey;">&#8377;$gst</td>
 </tr>
