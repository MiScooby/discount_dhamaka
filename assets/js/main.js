...
function ecAccessCookie(e) {
    for (
        var c = e + "=", d = document.cookie.split(";"), a = 0; a < d.length; a++
    ) {
        var b = d[a].trim();
...
function ecCheckCookie() {
    ...
    ecCheckCookie(),
        ...
        new(function({ offset: b } = { offset: 10 }) {
            ...
            return (
                ...
                window.addEventListener("resize", () => i(c), !1), { start: e, isElementOnScreen: f, update: a }
            );
        })({ offset: 20 });
    var b,
            ...
            if (!$(this).hasClass("active"))
                return (
                    ...
                    ($("link[href='assets/css/responsive.css']").before(
                        ...
                        ecCreateCookie("themeColorCookie", a, 1)), !1
                );
        }),
    ...
    $(".ec-main-menu ul li a").each(function() {
        if ("#" !== $(this).attr("href") && $(this).prop("href") == t)
            return (
                ...
                $(this).parent("li").addClass("active"), !1
            );
    });
    var u = $(
    ...
    $(".cart-qty-plus-minus").append(
        ...
        ($.fn.launchBtn = function(e) {
            ...
            (b = $(".ec-panel")),
            (f = 0),
            (g = $.extend({ openDuration: 600, closeDuration: 200, rotate: !0 },
                e
            )),
            (h = function() {
