...
<div class="row justify-content-center">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <?php
            $getCOuntofPlan = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `last_minute_deals_plan` WHERE `cat_id`='$id' AND (`plan_grade`='A-Area' OR `plan_grade`='B-Area' OR `plan_grade`='C-Area') GROUP BY plan_grade"));


            $getCOuntofPlanA = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `last_minute_deals_plan` WHERE `cat_id`='$id' AND `plan_grade`='A-Area' GROUP BY plan_grade"));
            $getCOuntofPlanB = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `last_minute_deals_plan` WHERE `cat_id`='$id' AND `plan_grade`='B-Area' GROUP BY plan_grade"));
            $getCOuntofPlanC = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `last_minute_deals_plan` WHERE `cat_id`='$id' AND `plan_grade`='C-Area' GROUP BY plan_grade"));
            ...
            ?>
                <div class="card-body">
                    ...
                    <h6 class="card-title">Add Category LMD Plan</h6>

                    <form class="forms-sample" action="javascript:;" id="LmDPlanForm" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="eItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="eItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="eItems[]" placeholder="Enter Plan Items">
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="pItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="pItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="pItems[]" placeholder="Enter Plan Items">
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="lItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="lItems[]" placeholder="Enter Plan Items">
                                        <input type="text" required class="form-control mb-3" oninput="this.value = this.value.replace(/\D+/g, '')" minlength="1" name="lItems[]" placeholder="Enter Plan Items">
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="text-center">
                            ...
                            <input type="hidden" name="type" id="type" value="lmdPlan">
                            <button type="submit" class="btn btn-primary me-2 w-50" id="AddLMDPlanBtn">Add Category Plan</button>
                        </div>
                    </form>
...
<script>
    ...
    $(document).on("submit", "#LmDPlanForm", function(e) {
        // alert();
        // e.preventDefault();
        //  alert();
