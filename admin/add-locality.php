...
if (!authChecker('admin', ['add_locality'])) { noAccessPage(); }
    ...
    <div class="col-md-7 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-title">Add Locality</h6>
                ...
                <form class="forms-sample" id="addLocalityForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="vAdd1" name="localityName" required placeholder="Enter Locality Name">
                    </div>
                    ...
                    <div class="mb-3">
                        <div>
                            ...
                            <div class="input-field">
                                <input type="text" id="sublocality_level_1" class="form-control" name="locality" placeholder="locality">
                                <span></span>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div>
                            ...
                            <div class="input-field">
                                <input type="text" id="locality" class="form-control" name="city" placeholder="City">
                                <span></span>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div>
                            ...
                            <div class="input-field">
                                <input type="text" id="administrative_area_level_1" class="form-control" name="state" placeholder="State">
                                <span></span>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div>
                            ...
                            <div class="input-field">
                                <input type="number" id="postal_code" class="form-control" name="zip-code" placeholder="10001">
                                <span></span>
                    ...
                    <div class="text-center">
                        <input type="hidden" name="addLocality" value="addLocality">
                        <button type="button" class="btn btn-primary me-2 w-50" id="AddLocalityBtn">Submit</button>
                    </div>
                </form>
...
<script>
    $(document).on("click", "#AddLocalityBtn", function(e) {
