                    ...
                    <div class="ec-sidebar-block">
                        <div class="ec-vendor-block">
                            ...
                            <div class="ec-vendor-block-items">
                                <ul>
                                    <li><a href="javascript:void(0);" class="tab-link active" data-tabc=".dashboard-prf-tab"><i class="fa fa-home"></i> Dashboard</a></li>

                                    <li><a href="javascript:void(0);" class="tab-link" data-tabc=".dash-prf-tab"><i class="fa fa-user"></i> My Profile</a></li>

                                    <li><a href="javascript:void(0);" class="tab-link" data-tabc=".brand-prf-tab"><i class="fa fa-bandcamp"></i> Brand</a></li>


                                    <li><a href="javascript:void(0);" class="tab-link" data-tabc=".edit-prf-tab"><i class="fa fa-tag"></i> Deals</a></li>
                ...
                <div class="ec-vendor-dashboard-card ec-vendor-setting-card">
                    <div class="coupon-dstab active dashboard-prf-tab">
                        <div class="ec-vendor-card-body">
                            <div class="row">
                                <?php
                                $checkSubsQuery = mysqli_query($con, "SELECT * FROM `vendor_membership` WHERE `vendor_id`='$VenDor[id]'");
                                            ...
                                            <div class="card_my bg-warning invoice-card">
                                                <div class="card-body d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        $next_due_date = date('Y-m-d', strtotime($planAdddate . ' + ' . $Plandays . 'days'));
                                                        ...
                                                        <?php if($current_date > $next_due_date){?>
                                                            <span class="btn btn_danger text-danger d-sm-inline-block d-none">Plan Expired<i class="las la-signal ms-3 scale5"></i></span>
                                                       <?php  }
                                                        ?><br>
                                                        <a class="btn btn-primary d-sm-inline-block d-none" <?= (date('Y-m-d') <= $next_due_date) ? 'href="javascript:;"' : 'href="choose-plan.php?' . $urltoken . '&' . $urltoken . '&&SubsPlan_type=memPlan&&' . $urltoken . '&' . $urltoken . '"'; ?>>Renew<i class="las la-signal ms-3 scale5"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-xxl-3 col-sm-6">
                                            <div class="card_my bg-success invoice-card">
                                                <div class="card-body d-flex">
                                                    ...
                                                    <?= ($checkLMDealCount > 0) ? '<div>
                                                        <h2 class="text-white invoice-num">Remaining Last Minute Deals</h2>
                                                        <a href="javascript:void(0);" class="btn btn-primary one_off">' . $checkLMDeal['plan_items'] . '<i class="las la-signal ms-3 scale5"></i></a>
                                                    </div>' : '<div>
                                                    <p class="text-white srb-fs-12">If you want to offer Last Minute Deals or Flash deals which are offered for 30 minutes to 24 Hours then you have to buy a separate package as they are charged on deal basis.                                                       
                                                    </p>
                                                    <a href="choose-plan.php?' . $urltoken . '&' . $urltoken . '&&SubsPlan_type=LmdealPlan&&' . $urltoken . '&' . $urltoken . '" class="btn btn-primary lmdealbtn">Buy Last Minute Deals<i class="las la-signal ms-3 scale5"></i></a>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="card-bx bg-blue">
                                                        ...
                                                        <div class="card-info text-white">
                                                            ...
                                                            <h2 class="text-white card-balance">Hi <?= $VenDor['f_name']; ?> here's quick overview of your stats.</h2>
                                                            <p class="fs-16"> <?= ($checkSubsQueryCount > 0) ? 'Deals: <span>' . $VedDealCount . '</span>' : '<a href="choose-plan.php?' . $urltoken . '&' . $urltoken . '&&SubsPlan_type=memPlan&&' . $urltoken . '&' . $urltoken . '" class="text-white">Please Subscribe With Discount Dhamaka Membership</a>'; ?> </p>
                                        ...
                                        <div class="col-md-12">
                                            <div>
                                                <div class="topheaddiv">
                                                    ...
                                                    <?php $planExpired ? $href = "javascript:void(0)" : $href ="edit_deal.php?id=". $dealQuerList['id'];?>
                                                    <a href="<?= $href;?>" <?php if($planExpired){?> disabled <?php }else{ '';};?> class="btn add_to_btn dealFormBtn clickaddeal" data-id=".add_dealfrm">Add Deal</a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul class="add_btns">
                                                                        ...
                                                                        <li>
                                                                           <?php $planExpired ? $href = "javascript:void(0)" : 
                                                                           $href ="edit_deal.php?id=". $dealQuerList['id'];?>
                                                                        <a  href="<?= $href;?>" style="padding:0;" type="submit" name="editDealBtn"><i class="fa fa-edit" aria-hidden="true" style="color: orange;"></i></a>
                                                                        </li>
